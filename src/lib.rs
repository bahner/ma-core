...
pub use service::{
    Service, BROADCAST_TOPIC, CONTENT_TYPE_CBOR, CONTENT_TYPE_TUPLE, CRUD_PROTOCOL_ID,
    INBOX_PROTOCOL_ID, IPFS_PROTOCOL_ID, MESSAGE_TYPE_BROADCAST, MESSAGE_TYPE_CHAT,
    MESSAGE_TYPE_CRUD_DELETE, MESSAGE_TYPE_CRUD_DELETE_REPLY, MESSAGE_TYPE_CRUD_EDIT,
    MESSAGE_TYPE_CRUD_EDIT_REPLY, MESSAGE_TYPE_CRUD_GET, MESSAGE_TYPE_CRUD_GET_REPLY,
    MESSAGE_TYPE_CRUD_SET, MESSAGE_TYPE_CRUD_SET_REPLY, MESSAGE_TYPE_DOC, MESSAGE_TYPE_EMOTE,
